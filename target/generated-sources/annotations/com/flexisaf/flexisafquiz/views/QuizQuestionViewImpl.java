...
@StaticImplementation(QuizQuestionView.class)
public class QuizQuestionViewImpl implements QuizQuestionView, EntityViewProxy {

    public static volatile EntityViewManager ENTITY_VIEW_MANAGER;
    public static final SerializableEntityViewManager SERIALIZABLE_ENTITY_VIEW_MANAGER = new SerializableEntityViewManager(QuizQuestionViewImpl.class, ENTITY_VIEW_MANAGER);
    ...
    public QuizQuestionViewImpl(QuizQuestionViewImpl noop, Map<String, Object> blazePersistenceOptionalParameters) {
    ...
    public QuizQuestionViewImpl(        Long id) {
        this.$$_kind = (byte) 1;
        this.correctOption = null;
        this.difficulty = null;
        this.id = id;
    ...
    public QuizQuestionViewImpl(QuizQuestionViewImpl noop, int offset, Object[] tuple) {
        super();
        ...
        this.text = (String) tuple[offset + 7];
    }

    public QuizQuestionViewImpl(QuizQuestionViewImpl noop, int offset, int[] assignment, Object[] tuple) {
        super();
        ...
        this.text = (String) tuple[offset + assignment[7]];
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QuizQuestionView) {
            QuizQuestionView other = (QuizQuestionView) obj;
    ...
    public String toString() {
        return "QuizQuestionView(id = " + this.id + ")";
    }
}
