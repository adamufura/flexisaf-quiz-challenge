...
public class QuizQuestionViewRelation<T, A extends MethodAttribute<?, ?>> extends AttributePathWrapper<T, QuizQuestionView, QuizQuestionView> {

    public QuizQuestionViewRelation(AttributePath<T, QuizQuestionView, QuizQuestionView> path) {
        super(path);
    }
