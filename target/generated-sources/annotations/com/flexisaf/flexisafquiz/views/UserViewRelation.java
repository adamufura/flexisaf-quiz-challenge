...
public class UserViewRelation<T, A extends MethodAttribute<?, ?>> extends AttributePathWrapper<T, UserView, UserView> {

    public UserViewRelation(AttributePath<T, UserView, UserView> path) {
        super(path);
    }
