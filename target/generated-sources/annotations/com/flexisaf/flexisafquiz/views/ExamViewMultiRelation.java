...
public class ExamViewMultiRelation<T, C extends Collection<ExamView>, A extends MethodPluralAttribute<?, ?, C>> extends AttributePathWrapper<T, ExamView, C> {

    public ExamViewMultiRelation(AttributePath<T, ExamView, C> path) {
        super(path);
    }
