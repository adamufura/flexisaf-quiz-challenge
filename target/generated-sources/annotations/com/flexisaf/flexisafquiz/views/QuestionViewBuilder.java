...
@StaticBuilder(QuestionView.class)
public abstract class QuestionViewBuilder<BuilderType extends EntityViewBuilderBase<QuestionView, BuilderType>> implements EntityViewBuilderBase<QuestionView, BuilderType> {
    ...
    protected SubjectSummaryView subject;
    protected String text;
    protected final Map<String, Object> blazePersistenceOptionalParameters;

    public QuestionViewBuilder(Map<String, Object> blazePersistenceOptionalParameters) {
    ...
    public void setSubject(SubjectSummaryView subject) {
        this.subject = subject;
    }
    public BuilderType withSubject(SubjectSummaryView subject) {
        this.subject = subject;
        return (BuilderType) this;
    }
    public SubjectSummaryViewBuilder.Nested<? extends BuilderType> withSubjectBuilder() {
    return new SubjectSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new SingularNameEntityViewBuilderListener(this, "subject"), (BuilderType) this);
    }
    ...
    public <ElementType> ElementType get(String attribute) {
        switch (attribute) {
            ...
            case "subject":
                return (ElementType) (Object) this.subject;
            case "text":
    ...
    @Override
    public <ElementType> ElementType get(SingularAttribute<QuestionView, ElementType> attribute) {
        return get((Attribute<?, ?>) attribute);
    }

    @Override
    public <CollectionType> CollectionType get(PluralAttribute<QuestionView, CollectionType, ?> attribute) {
        return get((Attribute<?, ?>) attribute);
    }
    ...
    public BuilderType with(String attribute, Object value) {
        switch (attribute) {
            ...
            case "optionD":
                ...
                break;
            case "subject":
                this.subject = value == null ? null : (SubjectSummaryView) value;
                break;
            case "text":
    ...
    @Override
    public <ElementType> BuilderType with(SingularAttribute<QuestionView, ElementType> attribute, ElementType value) {
    ...
    @Override
    public <CollectionType> BuilderType with(PluralAttribute<QuestionView, CollectionType, ?> attribute, CollectionType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <ElementType> BuilderType withElement(CollectionAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <ElementType> BuilderType withElement(SetAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <ElementType> BuilderType withElement(ListAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <ElementType> BuilderType withListElement(ListAttribute<QuestionView, ElementType> attribute, int index, ElementType value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <KeyType, ElementType> BuilderType withEntry(MapAttribute<QuestionView, KeyType, ElementType> attribute, KeyType key, ElementType value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (BuilderType) this;
    }
    ...
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withSingularBuilder(String attribute) {
        switch (attribute) {
            case "subject":
                return (EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?>) (EntityViewNestedBuilder<?, ?, ?>) withSubjectBuilder();
        }
        throw new IllegalArgumentException("Unknown attribute: " + attribute);
    }
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(SingularAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(CollectionAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(ListAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(ListAttribute<QuestionView, ElementType> attr, int index) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(SetAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(MapAttribute<QuestionView, KeyType, ElementType> attr, KeyType key) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<KeyType, ? extends EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?>, ?> withBuilder(MapAttribute<QuestionView, KeyType, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    public static class Init extends QuestionViewBuilder<EntityViewBuilder<QuestionView>> implements EntityViewBuilder<QuestionView> {
    ...
    public Init withSubject(SubjectSummaryView subject) {
        this.subject = subject;
        return (Init) this;
    }
    public SubjectSummaryViewBuilder.Nested<? extends Init> withSubjectBuilder() {
    return new SubjectSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new SingularNameEntityViewBuilderListener(this, "subject"), (Init) this);
    }
    ...
    @Override
    public <ElementType> Init with(SingularAttribute<QuestionView, ElementType> attribute, ElementType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <CollectionType> Init with(PluralAttribute<QuestionView, CollectionType, ?> attribute, CollectionType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <ElementType> Init withElement(CollectionAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Init) this;
    }

    @Override
    public <ElementType> Init withElement(SetAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Init) this;
    }

    @Override
    public <ElementType> Init withElement(ListAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Init) this;
    }

    @Override
    public <ElementType> Init withListElement(ListAttribute<QuestionView, ElementType> attribute, int index, ElementType value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (Init) this;
    }
    ...
    @Override
    public <KeyType, ElementType> Init withEntry(MapAttribute<QuestionView, KeyType, ElementType> attribute, KeyType key, ElementType value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (Init) this;
    }
    ...
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withSingularBuilder(String attribute) {
        switch (attribute) {
            case "subject":
                return (EntityViewNestedBuilder<ElementType, ? extends Init, ?>) (EntityViewNestedBuilder<?, ?, ?>) withSubjectBuilder();
        }
        throw new IllegalArgumentException("Unknown attribute: " + attribute);
    }
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(SingularAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSingularBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSingularBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(CollectionAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withCollectionBuilder(((MethodAttribute) attr).getName());
        } else {
            return withCollectionBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(ListAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName());
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(ListAttribute<QuestionView, ElementType> attr, int index) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName(), index);
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex(), index);
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(SetAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSetBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSetBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(MapAttribute<QuestionView, KeyType, ElementType> attr, KeyType key) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName(), key);
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex(), key);
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<KeyType, ? extends EntityViewNestedBuilder<ElementType, ? extends Init, ?>, ?> withBuilder(MapAttribute<QuestionView, KeyType, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName());
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex());
    ...
    public static class Nested<BuilderResult> extends QuestionViewBuilder<Nested<BuilderResult>> implements EntityViewNestedBuilder<QuestionView, BuilderResult, Nested<BuilderResult>> {
        ...
        public BuilderResult build() {
            blazePersistenceListener.onBuildComplete(new QuestionViewImpl(
            this.id,
            this.correctOption,
            this.difficulty,
            this.optionA,
    ...
    public Nested<BuilderResult> withSubject(SubjectSummaryView subject) {
        this.subject = subject;
        return (Nested<BuilderResult>) this;
    }
    public SubjectSummaryViewBuilder.Nested<? extends Nested<BuilderResult>> withSubjectBuilder() {
    return new SubjectSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new SingularNameEntityViewBuilderListener(this, "subject"), (Nested<BuilderResult>) this);
    }
    ...
    @Override
    public <ElementType> Nested<BuilderResult> with(SingularAttribute<QuestionView, ElementType> attribute, ElementType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <CollectionType> Nested<BuilderResult> with(PluralAttribute<QuestionView, CollectionType, ?> attribute, CollectionType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <ElementType> Nested<BuilderResult> withElement(CollectionAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Nested<BuilderResult>) this;
    }

    @Override
    public <ElementType> Nested<BuilderResult> withElement(SetAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Nested<BuilderResult>) this;
    }

    @Override
    public <ElementType> Nested<BuilderResult> withElement(ListAttribute<QuestionView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Nested<BuilderResult>) this;
    }

    @Override
    public <ElementType> Nested<BuilderResult> withListElement(ListAttribute<QuestionView, ElementType> attribute, int index, ElementType value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (Nested<BuilderResult>) this;
    }
    ...
    @Override
    public <KeyType, ElementType> Nested<BuilderResult> withEntry(MapAttribute<QuestionView, KeyType, ElementType> attribute, KeyType key, ElementType value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (Nested<BuilderResult>) this;
    }
    ...
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withSingularBuilder(String attribute) {
        switch (attribute) {
            case "subject":
                return (EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?>) (EntityViewNestedBuilder<?, ?, ?>) withSubjectBuilder();
        }
        throw new IllegalArgumentException("Unknown attribute: " + attribute);
    }
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(SingularAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSingularBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSingularBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(CollectionAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withCollectionBuilder(((MethodAttribute) attr).getName());
        } else {
            return withCollectionBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(ListAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName());
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(ListAttribute<QuestionView, ElementType> attr, int index) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName(), index);
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex(), index);
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(SetAttribute<QuestionView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSetBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSetBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(MapAttribute<QuestionView, KeyType, ElementType> attr, KeyType key) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName(), key);
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex(), key);
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<KeyType, ? extends EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?>, ?> withBuilder(MapAttribute<QuestionView, KeyType, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName());
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex());
