...
public class ExamQuestionViewRelation<T, A extends MethodAttribute<?, ?>> extends AttributePathWrapper<T, ExamQuestionView, ExamQuestionView> {

    public ExamQuestionViewRelation(AttributePath<T, ExamQuestionView, ExamQuestionView> path) {
        super(path);
    }
