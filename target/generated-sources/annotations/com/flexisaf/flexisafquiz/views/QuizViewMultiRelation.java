...
public class QuizViewMultiRelation<T, C extends Collection<QuizView>, A extends MethodPluralAttribute<?, ?, C>> extends AttributePathWrapper<T, QuizView, C> {

    public QuizViewMultiRelation(AttributePath<T, QuizView, C> path) {
        super(path);
    }
