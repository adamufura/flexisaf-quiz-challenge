...
public class QuestionViewRelation<T, A extends MethodAttribute<?, ?>> extends AttributePathWrapper<T, QuestionView, QuestionView> {

    public QuestionViewRelation(AttributePath<T, QuestionView, QuestionView> path) {
        super(path);
    }
