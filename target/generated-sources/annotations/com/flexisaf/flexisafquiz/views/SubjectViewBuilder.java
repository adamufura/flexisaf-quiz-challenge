...
@StaticBuilder(SubjectView.class)
public abstract class SubjectViewBuilder<BuilderType extends EntityViewBuilderBase<SubjectView, BuilderType>> implements EntityViewBuilderBase<SubjectView, BuilderType> {

    protected Long id;
    protected String name;
    protected List<QuestionSummaryView> questions;
    protected final Map<String, Object> blazePersistenceOptionalParameters;

    public SubjectViewBuilder(Map<String, Object> blazePersistenceOptionalParameters) {
        this.id = null;
        this.name = null;
    ...
    public void setQuestions(List<QuestionSummaryView> questions) {
        this.questions = questions;
    }
    public BuilderType withQuestions(List<QuestionSummaryView> questions) {
        this.questions = questions;
        return (BuilderType) this;
    }
    public QuestionSummaryViewBuilder.Nested<? extends BuilderType> withQuestionsBuilder(int index) {
        return new QuestionSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new ListEntityViewBuilderListener(getCollection("questions"), index), (BuilderType) this);
    }

    public QuestionSummaryViewBuilder.Nested<? extends BuilderType> withQuestionsBuilder() {
    return new QuestionSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new CollectionEntityViewBuilderListener(getCollection("questions")), (BuilderType) this);
    }
    ...
    @Override
    public <ElementType> ElementType get(SingularAttribute<SubjectView, ElementType> attribute) {
        return get((Attribute<?, ?>) attribute);
    }

    @Override
    public <CollectionType> CollectionType get(PluralAttribute<SubjectView, CollectionType, ?> attribute) {
        return get((Attribute<?, ?>) attribute);
    }
    ...
    public BuilderType with(String attribute, Object value) {
        switch (attribute) {
            ...
            case "name":
                ...
                break;
            case "questions":
                this.questions = value == null ? (List<QuestionSummaryView>) (java.util.List<?>) SubjectView_.questions.attr().getCollectionInstantiator().createCollection(0) : (List<QuestionSummaryView>) value;
                break;
            default:
                throw new IllegalArgumentException("Unknown attribute: " + attribute);
        }
    ...
    @Override
    public <ElementType> BuilderType with(SingularAttribute<SubjectView, ElementType> attribute, ElementType value) {
    ...
    @Override
    public <CollectionType> BuilderType with(PluralAttribute<SubjectView, CollectionType, ?> attribute, CollectionType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <ElementType> BuilderType withElement(CollectionAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <ElementType> BuilderType withElement(SetAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <ElementType> BuilderType withElement(ListAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <ElementType> BuilderType withListElement(ListAttribute<SubjectView, ElementType> attribute, int index, ElementType value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <KeyType, ElementType> BuilderType withEntry(MapAttribute<SubjectView, KeyType, ElementType> attribute, KeyType key, ElementType value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(SingularAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(CollectionAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(ListAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(ListAttribute<SubjectView, ElementType> attr, int index) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(SetAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?> withBuilder(MapAttribute<SubjectView, KeyType, ElementType> attr, KeyType key) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<KeyType, ? extends EntityViewNestedBuilder<ElementType, ? extends BuilderType, ?>, ?> withBuilder(MapAttribute<SubjectView, KeyType, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    public static class Init extends SubjectViewBuilder<EntityViewBuilder<SubjectView>> implements EntityViewBuilder<SubjectView> {
        ...
        @Override
        public SubjectView build() {
            return new SubjectViewImpl(
            this.id,
            this.name,
            this.questions
            );
    ...
    public Init withQuestions(List<QuestionSummaryView> questions) {
        this.questions = questions;
        return (Init) this;
    }
    public QuestionSummaryViewBuilder.Nested<? extends Init> withQuestionsBuilder(int index) {
        return new QuestionSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new ListEntityViewBuilderListener(getCollection("questions"), index), (Init) this);
    }

    public QuestionSummaryViewBuilder.Nested<? extends Init> withQuestionsBuilder() {
    return new QuestionSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new CollectionEntityViewBuilderListener(getCollection("questions")), (Init) this);
    }
    ...
    @Override
    public <ElementType> Init with(SingularAttribute<SubjectView, ElementType> attribute, ElementType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <CollectionType> Init with(PluralAttribute<SubjectView, CollectionType, ?> attribute, CollectionType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <ElementType> Init withElement(CollectionAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Init) this;
    }

    @Override
    public <ElementType> Init withElement(SetAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Init) this;
    }

    @Override
    public <ElementType> Init withElement(ListAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Init) this;
    }

    @Override
    public <ElementType> Init withListElement(ListAttribute<SubjectView, ElementType> attribute, int index, ElementType value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (Init) this;
    }
    ...
    @Override
    public <KeyType, ElementType> Init withEntry(MapAttribute<SubjectView, KeyType, ElementType> attribute, KeyType key, ElementType value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (Init) this;
    }
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(SingularAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSingularBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSingularBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(CollectionAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withCollectionBuilder(((MethodAttribute) attr).getName());
        } else {
            return withCollectionBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(ListAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName());
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(ListAttribute<SubjectView, ElementType> attr, int index) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName(), index);
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex(), index);
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(SetAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSetBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSetBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<ElementType, ? extends Init, ?> withBuilder(MapAttribute<SubjectView, KeyType, ElementType> attr, KeyType key) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName(), key);
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex(), key);
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<KeyType, ? extends EntityViewNestedBuilder<ElementType, ? extends Init, ?>, ?> withBuilder(MapAttribute<SubjectView, KeyType, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName());
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex());
    ...
    public static class Nested<BuilderResult> extends SubjectViewBuilder<Nested<BuilderResult>> implements EntityViewNestedBuilder<SubjectView, BuilderResult, Nested<BuilderResult>> {
        ...
        public BuilderResult build() {
            blazePersistenceListener.onBuildComplete(new SubjectViewImpl(
            this.id,
            this.name,
            this.questions
            ));
    ...
    public Nested<BuilderResult> withQuestions(List<QuestionSummaryView> questions) {
        this.questions = questions;
        return (Nested<BuilderResult>) this;
    }
    public QuestionSummaryViewBuilder.Nested<? extends Nested<BuilderResult>> withQuestionsBuilder(int index) {
        return new QuestionSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new ListEntityViewBuilderListener(getCollection("questions"), index), (Nested<BuilderResult>) this);
    }

    public QuestionSummaryViewBuilder.Nested<? extends Nested<BuilderResult>> withQuestionsBuilder() {
    return new QuestionSummaryViewBuilder.Nested<>(blazePersistenceOptionalParameters, new CollectionEntityViewBuilderListener(getCollection("questions")), (Nested<BuilderResult>) this);
    }
    ...
    @Override
    public <ElementType> Nested<BuilderResult> with(SingularAttribute<SubjectView, ElementType> attribute, ElementType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <CollectionType> Nested<BuilderResult> with(PluralAttribute<SubjectView, CollectionType, ?> attribute, CollectionType value) {
        if (attribute instanceof MethodAttribute) {
            return with(((MethodAttribute) attribute).getName(), value);
        } else {
            return with(((ParameterAttribute) attribute).getIndex(), value);
    ...
    @Override
    public <ElementType> Nested<BuilderResult> withElement(CollectionAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Nested<BuilderResult>) this;
    }

    @Override
    public <ElementType> Nested<BuilderResult> withElement(SetAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Nested<BuilderResult>) this;
    }

    @Override
    public <ElementType> Nested<BuilderResult> withElement(ListAttribute<SubjectView, ElementType> attribute, ElementType value) {
        getCollection(attribute).add(value);
        return (Nested<BuilderResult>) this;
    }

    @Override
    public <ElementType> Nested<BuilderResult> withListElement(ListAttribute<SubjectView, ElementType> attribute, int index, ElementType value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (Nested<BuilderResult>) this;
    }
    ...
    @Override
    public <KeyType, ElementType> Nested<BuilderResult> withEntry(MapAttribute<SubjectView, KeyType, ElementType> attribute, KeyType key, ElementType value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (Nested<BuilderResult>) this;
    }
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(SingularAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSingularBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSingularBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(CollectionAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withCollectionBuilder(((MethodAttribute) attr).getName());
        } else {
            return withCollectionBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(ListAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName());
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(ListAttribute<SubjectView, ElementType> attr, int index) {
        if (attr instanceof MethodAttribute) {
            return withListBuilder(((MethodAttribute) attr).getName(), index);
        } else {
            return withListBuilder(((ParameterAttribute) attr).getIndex(), index);
    ...
    @Override
    public <ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(SetAttribute<SubjectView, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withSetBuilder(((MethodAttribute) attr).getName());
        } else {
            return withSetBuilder(((ParameterAttribute) attr).getIndex());
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?> withBuilder(MapAttribute<SubjectView, KeyType, ElementType> attr, KeyType key) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName(), key);
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex(), key);
    ...
    @Override
    public <KeyType, ElementType> EntityViewNestedBuilder<KeyType, ? extends EntityViewNestedBuilder<ElementType, ? extends Nested<BuilderResult>, ?>, ?> withBuilder(MapAttribute<SubjectView, KeyType, ElementType> attr) {
        if (attr instanceof MethodAttribute) {
            return withMapBuilder(((MethodAttribute) attr).getName());
        } else {
            return withMapBuilder(((ParameterAttribute) attr).getIndex());
